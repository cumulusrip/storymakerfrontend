      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-lg font-bold text-gradient">StoryShort</span>
            </div>
            <p className="text-sm text-muted-foreground max-w-xs">
              Create viral faceless videos on auto-pilot with the power of AI.
            </p>
          </div>
        ...
        <div className="border-t border-border/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-sm text-muted-foreground">
            © 2024 StoryShort AI. All rights reserved.
          </p>
